  ...
  https.get(url, function(response) {
    ...
    response.on('end', () => {
      try {
        ...
        const creatTable = "CREATE TABLE IF NOT EXISTS "+ "msft"+"( id INT NOT NULL AUTO_INCREMENT, timePoint DATETIME,minuteOpen double,minuteHigh double,minuteLow double,minuteClose double,minuteVolume double,PRIMARY KEY(id));"
...
app.listen(3000,function() {
  ...
  const loop = async () => {
    for (let i = 0; i < 100; i++ ) {
            ...
            console.log(myfunction(1,valueStartingMonth, valueStartingDay, valueEndMonth, valueEndDay,currentStartYear, currentEndYear));
              //console.log(startDay);
              //console.log(startingDate.getDate())
              //console.log("the month is " + startingDate.getMonth())
            // }
